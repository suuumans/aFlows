...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "/Users/suman/programming/aflows/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/suman/programming/aflows/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../prisma",
...
/**
  ...
  /**
   * `prisma.workfolw`: Exposes CRUD operations for the **Workfolw** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Workfolws
    * const workfolws = await prisma.workfolw.findMany()
    * ```
    */
  get workfolw(): Prisma.WorkfolwDelegate<ExtArgs, { omit: OmitOpts }>;
}
