...
import { CreditCard, CreditCardIcon, FolderOpenIcon, HistoryIcon, Key, KeyIcon, LogOutIcon, StarIcon,  } from "lucide-react"
...
`              <Image src="/logos/Logoipsum-246.svg" alt="applogo" width={25} height={25} />
              <span className="font-semibold text-sm">aFlows</span>
            </Link>
          </SidebarMenuButton>
        </SidebarMenuItem>
      </SidebarHeader>
      ...
      <SidebarFooter>
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton tooltip="Upgrade to Premium" className="gap-x-4 h-10 px-4" onClick={() => authClient.checkout({ slug: "aFlows"})}>
