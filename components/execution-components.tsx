...
export const ExecutionHeader = ({ title, description, newButtonLabel, disabled, isCreating, onNew, newButtonHref }: ExecutionHeaderProps) => {
  return (
...
interface StateViewProps { message?: string; }
...
export const EmptyView = ({ message, onNew }: EmptyViewProps) => {
  return (
    <Empty className="border border-dashed bg-whte">
      <EmptyHeader>
...
export const ExecutionItem = ({ href, title, subtitle, image, actions, onRemove, isRemoving, className }: ExecutionItemProps) => {
