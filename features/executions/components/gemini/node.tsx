...
export const GeminiNode = memo((props: NodeProps<GeminiNodeType>) => {
  ...
  return (
    ...
    <BaseExecutionNode {...props} id={props.id} icon="/logos/Gemini.svg" name="Gemini" description={description} onSettings={handleSettings} onDoubleClick={handleSettings} status={nodeStatus} />
    </>
  )
})
