...
import { EmptyView, ErrorView, ExecutionContainer, ExecutionHeader, ExecutionItem, ExecutionList, ExecutionPagination, ExecutionSearch, LoadingView } from "@/components/execution-components";
...
export const WorkflowsList = () => {
  ...
  return (
    <ExecutionList items={workflows.data.items} getKey={(workflow) => workflow.id} renderItem={(workflow) => <WorkflowItem data={workflow} />} emptyView={<WorkflowsEmpty />} />
  )
}
